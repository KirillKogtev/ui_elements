...
export default (
    <div>
        ...
        <div>
            Элемент слева <br/>
            <Button
                leftElements={<img src="https://cs6.pikabu.ru/post_img/2017/05/31/10/149624840938786004.png" alt=""/>}
                text={'Левый элемент'}
            />
        </div>
        <div>
            Элемент справа <br/>
            <Button
                rightElements={<img src="https://cs6.pikabu.ru/post_img/2017/05/31/10/149624840938786004.png" alt=""/>}
                text={'Правый элемент'}
            />
        </div>
    </div>
